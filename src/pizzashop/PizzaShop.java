 ...
 * Freeman, E.Freeman, E., Sierra, K., & Bates, B. (2004). Head First Design
...
public class PizzaShop {
    ...
    // public static PizzaCutter pizzaCutter = new PizzaCutter();//we only ever want
    // one
    ...
    public static void main(String[] args) {
        ...
        PizzaCutter pizzaCutter = PizzaCutter.getInstance(); // Singleton instance
        pizzaCutter.setNumSlices(numSlices);

        if (pizza != null) {
            pizza.bake(350); // Example baking temp
            System.out.println("Your pizza has been baked and cut into " + pizzaCutter.getNumSlices() + " slices!");
        } else {
